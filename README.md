...
> [!WARNING]
> This project is now in maintenance mode. No new features will be added. For something more up to date, please see my new project [bomb-shell](https://github.com/kianblakley/bomb-shell).
